...
<body>
<li>
Regular partial sums are computed for each model (see <a href=https://met.readthedocs.io/en/latest/Users_Guide/appendixC.html#partial-sums-lines-sl1l2-sal1l2-vl1l2-val1l2" target="_blank">here</a>). Each model's forecast are verified against ONLYSFC (ADPSFC and SFCSHP) surface observations from the NAM PREPBUFR files and ADPUPA upper-air observations from the GDAS PREPBUFR files that fall in a 45 minute window of the valid time. All data are regridded using bilinear interpolation, if needed, to the <a href=http://www.nco.ncep.noaa.gov/pmb/docs/on388/grids/grid003.gif target="_blank">G003</a> (1x1 degree) grid for upper-air variables and to the <a href=http://www.nco.ncep.noaa.gov/pmb/docs/on388/grids/grid104.gif target="_blank">G104</a> (1x1 degree) grid for surface variables.
</li>
<br>
<li>
...
The verification regions used for surface (ONLYSF observations) are:
                     ...
                     <a href="../images/vx_masks/GMC.png" target="_blank">Gulf of Mexico Coast</a>,
