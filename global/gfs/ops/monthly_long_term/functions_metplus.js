...
function updateMobile(){
	...
	document.getElementById('page-middle').innerHTML = '<font size="1">Swipe Left/Right on Image = Change forecast lead | Swipe Up/Down on Image = Change level<br>For annual mean graphics, <a href="../annual_means.php">click here</a>';
	}
