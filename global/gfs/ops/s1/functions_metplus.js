...
function showImage(){
	...
	document.getElementById('map').src = variables[idx_var].images[imageObj.frame].src;
...
function updateMobile(){
	...
	|| navigator.userAgent.match(/Windows Phone/i)
		...
		document.getElementById('page-middle').innerHTML = '<font size="1">Swipe Left/Right on Image = Change month | Swipe Up/Down on Image = Change year<br>To view the GFS yearly S1 time series plot, <a href="gfs_data/annual_plots/historic_s1_yearly_scores.png" target="_blank">click here</a></font>';
	}
