...
<br>To view the GFS yearly S1 time series plot, <a href="gfs_data/annual_plots/historic_s1_yearly_scores.png" target="_blank">click here</a>
<!-- /Middle menu -->
</div>
...
<!-- Image -->
<div id="page-map">
        <iframe id="map" style="width:100%; height:800px;"></iframe>
</div>
...
var url = "gfs_data/DDD/wmxrptVVV";
