...
<br>For more information on this image, <button class="infobutton" id="myBtn">click here</button>
<div id="myModal" class="modal">
  <div class="modal-content" style="font-size:130%;">
    <span class="close">&times;</span>
    Additional Image Information
    <embed width=100% height=90% src="naefs_info.php">
  </div>
</div>
<!-- /Middle menu -->
</div>
...
var url = "https://www.emc.ncep.noaa.gov/gmb/yluo/naefs/VRFY_STATS/NCEP_CMC/DDDvLLL_VVV_SSS.gif";
