...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">NORTH AMERICAN ENSEMBLE FORECAST SYSTEM (NAEFS)</a></span>
</div>
...
<div id="pageContents">
<center>
<img src="../../../../style/images/naefs_logo.jpg" alt="" width="160" />
<br>
<br>
The North America Ensemble Forecasting System (NAEFS) is a multi-national effort between Canada, the United States, and Mexico to produce forecast guidance from ensemble forecasts run at Environment Canada and the National Centers for Environmental Prediction. NAEFS accounts for uncertainty in weather forecasts by generating an ensemble of multiple forecasts, each different from each other due to either slightly different initial conditions or slightly different model physics, in order to capture the range of possible forecast outcomes.
<br>
<br>
<a style="color:#ff0000">This webpage provides information on <u>operational NAEFS forecast skill</u>.
<br>
Please use the links on the left to navigate to NAEFS verification statistics.</a> 
<br>
<br>
<b>Additional Information:</b>
<br>
NAEFS is run 2-times daily (0000 and 1200 UTC) with 50 ensemble members out to 16 days. <!--You can learn more about the operational NAEFS configuration <a href=https://www.emc.ncep.noaa.gov/gmb/yzhu/imp/i201704/NAEFS_V6_ODB_highlights.pdf target="_blank">here</a>.--> 
</center>
</div>
</body>
