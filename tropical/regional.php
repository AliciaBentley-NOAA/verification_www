...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_main" src="https://www.emc.ncep.noaa.gov/users/verification/tropical/2021/regional/AL/AL_2021_ALL/images/ABSTK_ERR_fhrmean_AL_2021_ALL_regional.png" style="width:100%">
        </td>
    </tbody>
</table>
</div>
