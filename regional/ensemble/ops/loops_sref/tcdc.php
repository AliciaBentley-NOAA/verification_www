...
var url = "https://www.emc.ncep.noaa.gov/bzhou/verf_sref_gefs_4web/DDD_Tcloud_VVV_SSS.png";
...
variables.push({
        displayName: "Brier Score (cloudness<10%)",
        name: "le10_BS",
});
...
variables.push({
        displayName: "Brier Score (cloudness>50%)",
        name: "gt50_BS",
});

variables.push({
        displayName: "Brier Score (cloudness>90%)",
        name: "gt90_BS",
});


variables.push({
        displayName: "ROC Area (cloudness<10%)",
        name: "le10_ROCA",
});
...
variables.push({
        displayName: "ROC Area (cloudness>50%)",
        name: "gt50_ROCA",
});

variables.push({
        displayName: "ROC Area (cloudness>90%)",
        name: "gt90_ROCA",
});

variables.push({
        displayName: "Reliability (cloudness<10%)",
        name: "le10_Reliab",
});
...
variables.push({
        displayName: "Reliability (cloudness>50%)",
        name: "gt50_Reliab",
});

variables.push({
        displayName: "Reliability (cloudness>90%)",
        name: "gt90_Reliab",
});
