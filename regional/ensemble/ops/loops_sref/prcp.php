...
-->
        ...
        <div class="element">
                <span class="bold">Accumulated time:</span>
...
var url = "https://www.emc.ncep.noaa.gov/bzhou/verf_sref_gefs_4web/DDD_APCPLLL_VVV_SSS.png";
...
variables.push({
        displayName: "Frequency Bias of ensemble mean",
        name: "FBias",
});
...
variables.push({
        displayName: "BS-Reliability Component",
        name: "Reliability",
});
...
variables.push({
        displayName: "Reliability (>0.01 mm)",
        name: "gt0.01_Reliab",
});

variables.push({
        displayName: "Reliability (>0.5 mm)",
        name: "gt0.5_Reliab",
});


variables.push({
        displayName: "Reliability (>1 mm)",
        name: "gt1_Reliab",
});

variables.push({
        displayName: "Reliability (>5 mm)",
        name: "gt5_Reliab",
});

variables.push({
        displayName: "Reliability (>10 mm)",
        name: "gt10_Reliab",
});

variables.push({
        displayName: "Reliability (>25 mm)",
        name: "gt25_Reliab",
});

variables.push({
        displayName: "Reliability (>50 mm)",
        name: "gt50_Reliab",
});

variables.push({
        displayName: "Reliability (>75 mm)",
        name: "gt75_Reliab",
});
