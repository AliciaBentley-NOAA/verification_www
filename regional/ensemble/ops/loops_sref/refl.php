...
<div class="page-middle" id="page-middle">
  <font color="red" size=+1> Note: since there is no reflectivity ensemble product in GEFS, 
<br> SREF reflectivity is not evaluated/compared </font>  <button class="infobutton" id="myBtn">click here</button>
...
var url = "https://www.emc.ncep.noaa.gov/bzhou/verf_sref_gefs_4web/DDD_APCP06h_VVV_SSS.png";
