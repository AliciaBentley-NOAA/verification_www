...
var url = "https://www.emc.ncep.noaa.gov/bzhou/verf_sref_gefs_4web/DDD_CEIL_VVV_SSS.png";
...
variables.push({
        displayName: "RMSE and EnsembleSpread",
        name: "RMSE_Spread",
});

variables.push({
        displayName: "CRPS Score",
        name: "CRPS",
});
...
variables.push({
        displayName: "CSI of Ensemble Mean",
        name: "CSI",
});
...
variables.push({
        displayName: "Brier Score (Ceiling<1000 feet)",
        name: "le305_BS",
});

variables.push({
        displayName: "Brier Score (Ceiling<2000 feet)",
        name: "le610_BS",
});


variables.push({
        displayName: "Brier Score (Ceiling<3000 feet)",
        name: "le1000_BS",
});

variables.push({
        displayName: "Brier Score (Ceiling<9000 feet)",
        name: "le3000_BS",
});

variables.push({
        displayName: "ROC Area (Ceiling<1000 feet)",
        name: "le305_ROCA",
});

variables.push({
        displayName: "ROC Area (Ceiling<2000 feet)",
        name: "le610_ROCA",
});


variables.push({
        displayName: "ROC Area (Ceiling<3000 feet)",
        name: "le1000_ROCA",
});

variables.push({
        displayName: "ROC Area (Ceiling<9000 feet)",
        name: "le3000_ROCA",
});


variables.push({
        displayName: "Reliability (Ceiling<1000 feet)",
        name: "le305_Reliab",
});

variables.push({
        displayName: "Reliability (Ceiling<2000 feet)",
        name: "le610_Reliab",
});


variables.push({
        displayName: "Reliability (Ceiling<3000 feet)",
        name: "le1000_Reliab",
});

variables.push({
        displayName: "Reliability (Ceiling<9000 feet)",
        name: "le3000_Reliab",
});
