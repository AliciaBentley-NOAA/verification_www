...
var url = "https://www.emc.ncep.noaa.gov/bzhou/verf_sref_gefs_4web/DDD_Visibility_VVV_SSS.png";
...
variables.push({
        displayName: "Brier Score (Vis<500 m)",
        name: "le500_BS",
});

variables.push({
        displayName: "Brier Score (Vis<1000 m)",
        name: "le1000_BS",
});

variables.push({
        displayName: "Brier Score (Vis<2000 m)",
        name: "le2000_BS",
});

variables.push({
        displayName: "Brier Score (Vis<4000 m)",
        name: "le4000_BS",
});

variables.push({
        displayName: "Brier Score (Vis<6000 m)",
        name: "le6000_BS",
});

variables.push({
        displayName: "Brier Score (Vis<8000 m)",
        name: "le8000_BS",
});


variables.push({
        displayName: "ROC Area (Vis<500 m)",
        name: "le500_ROCA",
});

variables.push({
        displayName: "ROC Area (Vis<1000 m)",
        name: "le1000_ROCA",
});

variables.push({
        displayName: "ROC Area (Vis<2000 m)",
        name: "le2000_ROCA",
});

variables.push({
        displayName: "ROC Area (Vis<4000 m)",
        name: "le4000_ROCA",
});

variables.push({
        displayName: "ROC Area (Vis<6000 m)",
        name: "le6000_ROCA",
});

variables.push({
        displayName: "ROC Area (Vis<8000 m)",
        name: "le8000_ROCA",
});


variables.push({
        displayName: "Reliability (Vis<500 m)",
        name: "le500_Reliab",
});

variables.push({
        displayName: "Reliability (Vis<1000 m)",
        name: "le1000_Reliab",
});

variables.push({
        displayName: "Reliability (Vis<2000 m)",
        name: "le2000_Reliab",
});

variables.push({
        displayName: "Reliability (Vis<4000 m)",
        name: "le4000_Reliab",
});

variables.push({
        displayName: "Reliability (Vis<6000 m)",
        name: "le6000_Reliab",
});

variables.push({
        displayName: "Reliability (Vis<8000 m)",
        name: "le8000_Reliab",
});
