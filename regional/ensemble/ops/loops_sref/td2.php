...
var url = "https://www.emc.ncep.noaa.gov/bzhou/verf_sref_gefs_4web/DDD_TdLLL_VVV_SSS.png";
...
variables.push({
        displayName: "Brier Score (2m Td>60F)",
        name: "gt288.71_BS",
});

variables.push({
        displayName: "ROC Area (2m Td>60F)",
        name: "gt288.71_ROCA",
});

variables.push({
        displayName: "Reliability (2m Td>60F)",
        name: "gt288.71_Reliab",
});

variables.push({
        displayName: "ETS (2m Td>60F)",
        name: "ETS",
});

variables.push({
        displayName: "Freq Bias (2m Td>60F)",
        name: "FBIAS",
});

variables.push({
        displayName: "Hit Rate (2m Td>60F)",
        name: "PODY",
});
