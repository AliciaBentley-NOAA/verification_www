...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">REGIOANAL ENSEMBLE CLOUD VERIFICATION AGAINST STATIONS  
                                       </a></span>
</div>
...
var url = "https://www.emc.ncep.noaa.gov/bzhou/verf_cloud_4web/YYYY/Cloud_STATION_YYYYMM_VVV_Regn_DDD.png";
...
variables.push({
        displayName: "Brier Score (for cloudness <10%)",
        name: "BS_le10_fhr",
});
...
variables.push({
        displayName: "Brier Score (for cloudness >50%)",
        name: "BS_gt50_fhr",
});


variables.push({
        displayName: "Brier Score (for cloudness >90%)",
        name: "BS_gt90_fhr",
});


variables.push({
        displayName: "ROC Area (for cloudness <10%)",
        name: "ROC_AUC_le10_fhr",
});

variables.push({
        displayName: "ROC Area (for cloudness >10%)",
        name: "ROC_AUC_gt10_fhr",
});

variables.push({
        displayName: "ROC Area (for cloudness >50%)",
        name: "ROC_AUC_gt50_fhr",
});

variables.push({
        displayName: "ROC Area (for cloudness >90%)",
        name: "ROC_AUC_gt90_fhr",
});

variables.push({
        displayName: "Reliability (for cloudness <10%)",
        name: "Reliab_le10_fhr",
});

variables.push({
        displayName: "Reliability (for cloudness >10%)",
        name: "Reliab_gt10_fhr",
});

variables.push({
        displayName: "Reliability (for cloudness >50%)",
        name: "Reliab_gt50_fhr",
});

variables.push({
        displayName: "Reliability (for cloudness >90%)",
        name: "Reliab_gt90_fhr",
});
