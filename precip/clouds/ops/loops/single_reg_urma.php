...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">CLOUD VERIFICATION AGAINST URMA FOR SINGLE MODELS 
                                       </a></span>
</div>
...
Left/Right arrow keys = Change statistic | Up/Down arrow keys = Change model 
...
var url = "https://www.emc.ncep.noaa.gov/bzhou/verf_cloud_4web/YYYY/Cloud_URMA_YYYYMM_VVV_DDD.png";
...
variables.push({
        displayName: "RMSE ~ days",
        name: "RMSE_TimeSeries_12Fhr",
});
variables.push({
...
variables.push({
        displayName: "12fhr Mean Error ~ days",
        name: "ME_TimeSeries_12Fhr",
});

variables.push({
        displayName: "12fhr ETS ~ thresholds",
        name: "ETS_12Fhr_thres",
});
...
variables.push({
        displayName: "12fhr FBias ~ thresholds",
        name: "FBIAS_12Fhr_thres",
});
