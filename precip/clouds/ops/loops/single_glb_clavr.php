...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">GFS CLOUD VERIFICATION AGAINST CLAVR    
                                       </a></span>
</div>
...
var url = "https://www.emc.ncep.noaa.gov/bzhou/verf_cloud_4web/YYYY/Cloud_CLAVR_YYYYMM_VVV_Global_LLL.png";
...
levels.push({
        displayName: "High cloud",
        name: "Hi-cloud",
});

levels.push({
        displayName: "Mid cloud",
        name: "Md-cloud",
});
