...
function getURL(fhr,model,region,day,month,year,frame){
	...
	*/
        ...
        if( (region=="AK.") || (region=="HI.") || (region=="PR.") ){
                var newurl = url_oconus.replace("RRR",region);
        }else{
...
function changeLeftregion(id){
        ...
        if(selected_leftregion==""){
             region_models = CONUS_models;
             region_models_name = CONUS_models_name;
        }
        else if(selected_leftregion=="AK."){
             region_models = AK_models;
             region_models_name = AK_models_name;
        }
        else if(selected_leftregion=="HI."){
             region_models = HI_models;
             region_models_name = HI_models_name;
        }
        else if(selected_leftregion=="PR."){
             region_models = PR_models;
             region_models_name = PR_models_name;
        }
...
function changeLeftmodel(id){
        ...
        if(selected_leftmodel=="qpe"){
             model_fhrs = qpe_fhrs;
        }
        else if( (selected_leftmodel=="cmc") || (selected_leftmodel=="conusarw") || (selected_leftmodel=="conusarw2") || (selected_leftmodel=="conusnmmb") ){
             model_fhrs = cmc_fhrs;
        }
        else if(selected_leftmodel=="cmcglb"){
             model_fhrs = cmcglb_fhrs;
        }
        else if(selected_leftmodel=="conusnest"){
             model_fhrs = conusnest_fhrs;
        }
        else if(selected_leftmodel=="dwd"){
             model_fhrs = dwd_fhrs;
        }
        else if(selected_leftmodel=="ecmwf"){
             model_fhrs = ecmwf_fhrs;
        }
        else if(selected_leftmodel=="firewxcs"){
             model_fhrs = firewxcs_fhrs;
        }
        else if( (selected_leftmodel=="fv3lam") || (selected_leftmodel=="fv3lamx") || (selected_leftmodel=="fv3lamda") || (selected_leftmodel=="fv3lamdax") || (selected_leftmodel=="conusfv3") || (selected_leftmodel=="rrfsp1") || (selected_leftmodel=="rrfs_a") ){
             model_fhrs = fv3lam_fhrs;
        }
        else if(selected_leftmodel=="gec00"){
             model_fhrs = cmcglb_fhrs;
        }
        else if( (selected_leftregion=="") && (selected_leftmodel=="gfs") ){
             model_fhrs = gfs_fhrs;
        }
        else if( (selected_leftregion!="") && (selected_leftmodel=="gfs") ){
             model_fhrs = gfsshort_fhrs;
        }
        else if(selected_leftmodel=="gfsv16"){
             model_fhrs = gfs_fhrs;
        }
        else if(selected_leftmodel=="hrrr"){
             model_fhrs = hrrr_fhrs;
        }
        else if( (selected_leftmodel=="jma") || (selected_leftmodel=="metfr")){
             model_fhrs = jma_fhrs;
        }
        else if(selected_leftmodel=="medley"){
             model_fhrs = medley_fhrs;
        }
        else if( (selected_leftregion=="") && (selected_leftmodel=="nam") ){
             model_fhrs = nam_fhrs;
        }
        else if( (selected_leftregion!="") && (selected_leftmodel=="nam") ){
             model_fhrs = namshort_fhrs;
        }
        else if( (selected_leftmodel=="ndas") || (selected_leftmodel=="ndassoil") || (selected_leftmodel=="nohrsc") ){
             model_fhrs = ndas_fhrs;
        }
        else if(selected_leftmodel=="nssl4arw"){
             model_fhrs = nssl4arw_fhrs;
        }
        else if( (selected_leftregion=="") && (selected_leftmodel=="rap") ){
             model_fhrs = rap_fhrs;
        }
        else if( (selected_leftregion!="") && (selected_leftmodel=="rap") ){
             model_fhrs = rapshort_fhrs;
        }
        else if( (selected_leftmodel=="srfreqm") || (selected_leftmodel=="srmean") ){
             model_fhrs = srfreqm_fhrs;
        }   
        else if( (selected_leftmodel=="akarw") || (selected_leftmodel=="akarw2") || (selected_leftmodel=="aknmmb") ){
             model_fhrs = akarw_fhrs;
        }
        else if(selected_leftmodel=="aknest"){
             model_fhrs = aknest_fhrs;
        }
        else if(selected_leftmodel=="hrrrak"){
             model_fhrs = hrrrak_fhrs;
        }
        else if( (selected_leftmodel=="hiarw") || (selected_leftmodel=="hiarw2") || (selected_leftmodel=="hinmmb") ){
             model_fhrs = hiarw_fhrs;
        }
        else if(selected_leftmodel=="hinest"){
             model_fhrs = hinest_fhrs;
        }
        else if( (selected_leftmodel=="prarw") || (selected_leftmodel=="prarw2") || (selected_leftmodel=="prnmmb") ){
             model_fhrs = prarw_fhrs;
        }
        else if(selected_leftmodel=="prnest"){
             model_fhrs = prnest_fhrs;
        }
...
function changeRightregion(id){
        ...
        if(selected_rightregion==""){
             region_models = CONUS_models;
             region_models_name = CONUS_models_name;
        }
        else if(selected_rightregion=="AK."){
             region_models = AK_models;
             region_models_name = AK_models_name;
        }
        else if(selected_rightregion=="HI."){
             region_models = HI_models;
             region_models_name = HI_models_name;
        }
        else if(selected_rightregion=="PR."){
             region_models = PR_models;
             region_models_name = PR_models_name;
        }
...
function changeRightmodel(id){
        ...
        if(selected_rightmodel=="qpe"){
             model_fhrs = qpe_fhrs;
        }
        else if( (selected_rightmodel=="cmc") || (selected_rightmodel=="conusarw") || (selected_rightmodel=="conusarw2") || (selected_rightmodel=="conusnmmb") ){
             model_fhrs = cmc_fhrs;
        }
        else if(selected_rightmodel=="cmcglb"){
             model_fhrs = cmcglb_fhrs;
        }
        else if(selected_rightmodel=="conusnest"){
             model_fhrs = conusnest_fhrs;
        }
        else if(selected_rightmodel=="dwd"){
             model_fhrs = dwd_fhrs;
        }
        else if(selected_rightmodel=="ecmwf"){
             model_fhrs = ecmwf_fhrs;
        }
        else if(selected_rightmodel=="firewxcs"){
             model_fhrs = firewxcs_fhrs;
        }
        else if( (selected_rightmodel=="fv3lam") || (selected_rightmodel=="fv3lamx") || (selected_rightmodel=="fv3lamda") || (selected_rightmodel=="fv3lamdax") || (selected_rightmodel=="conusfv3") || (selected_rightmodel=="rrfsp1") || (selected_rightmodel=="rrfs_a") ){
             model_fhrs = fv3lam_fhrs;
        }
        else if(selected_rightmodel=="gec00"){
             model_fhrs = cmcglb_fhrs;
        }        
        else if( (selected_rightregion=="") && (selected_rightmodel=="gfs") ){
             model_fhrs = gfs_fhrs;
        }
        else if( (selected_rightregion!="") && (selected_rightmodel=="gfs") ){
             model_fhrs = gfsshort_fhrs;
        }
        else if(selected_rightmodel=="gfsv16"){
             model_fhrs = gfs_fhrs;
        }
        else if(selected_rightmodel=="hrrr"){
             model_fhrs = hrrr_fhrs;
        }
        else if( (selected_rightmodel=="jma") || (selected_rightmodel=="metfr")){
             model_fhrs = jma_fhrs;
        }
        else if(selected_rightmodel=="medley"){
             model_fhrs = medley_fhrs;
        }
        else if( (selected_rightregion=="") && (selected_rightmodel=="nam") ){
             model_fhrs = nam_fhrs;
        }
        else if( (selected_rightregion!="") && (selected_rightmodel=="nam") ){
             model_fhrs = namshort_fhrs;
        }
        else if( (selected_rightmodel=="ndas") || (selected_rightmodel=="ndassoil") || (selected_rightmodel=="nohrsc") ){
             model_fhrs = ndas_fhrs;
        }
        else if(selected_rightmodel=="nssl4arw"){
             model_fhrs = nssl4arw_fhrs;
        }
        else if( (selected_rightregion=="") && (selected_rightmodel=="rap") ){
             model_fhrs = rap_fhrs;
        }
        else if( (selected_rightregion!="") && (selected_rightmodel=="rap") ){
             model_fhrs = rapshort_fhrs;
        }
        else if( (selected_rightmodel=="srfreqm") || (selected_rightmodel=="srmean") ){
             model_fhrs = srfreqm_fhrs;
        }
        else if( (selected_rightmodel=="akarw") || (selected_rightmodel=="akarw2") || (selected_rightmodel=="aknmmb") ){
             model_fhrs = akarw_fhrs;
        }
        else if(selected_rightmodel=="aknest"){
             model_fhrs = aknest_fhrs;
        }
        else if(selected_rightmodel=="hrrrak"){
             model_fhrs = hrrrak_fhrs;
        }
        else if( (selected_rightmodel=="hiarw") || (selected_rightmodel=="hiarw2") || (selected_rightmodel=="hinmmb") ){
             model_fhrs = hiarw_fhrs;
        }
        else if(selected_rightmodel=="hinest"){
             model_fhrs = hinest_fhrs;
        }
        else if( (selected_rightmodel=="prarw") || (selected_rightmodel=="prarw2") || (selected_rightmodel=="prnmmb") ){
             model_fhrs = prarw_fhrs;
        }
        else if(selected_rightmodel=="prnest"){
             model_fhrs = prnest_fhrs;
        }
