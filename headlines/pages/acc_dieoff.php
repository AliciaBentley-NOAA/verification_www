...
<!-- Head element -->
<div class="page-top">
	<span><a class="img" href="../" target="_top" style="color:#ffffff">&lsaquo;&lsaquo; Return to Headline Scores</a><a style="color:#ffffff">  ||  Anomaly Correlation Coefficient Die-off Plot (2021)</a></span>
</div>

<!-- Image -->
<div id="page-map">
	<image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/acc_dieoff/NH_H500_PAC_2021.png">
</div>
